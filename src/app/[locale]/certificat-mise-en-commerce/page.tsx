...
import CreationPage, { BasicPrice, Tier } from "@/components/ui/shared/page-creation";
...
export default async function CertificateOfCommercialization() {
    const certificateOfCommercialization = await getTranslations("CourierService.certificateOfCommercialization");
        ...
        <>
            ...
            <div className="relative overflow-hidden ">
                ...
                <CreationPage
                    ...
                    eyebrow={certificateOfCommercialization("eyebrow")}
                    title={certificateOfCommercialization("title")}
                    description={
                        <>
                            <p>{certificateOfCommercialization("description")}</p>
                        </>
                    }
                    imageSrc="/images/courier/courier-5.jpg"
                    basicDisplayPrice={basicPrice}
                    t={certificateOfCommercialization}
                />
                <ElegantCardWrapper />
